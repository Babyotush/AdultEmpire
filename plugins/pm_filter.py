...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("Comrade I couldn't find anything related to that. Check your spelling")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply("Comrade I couldn't find anything related to that\nDid you mean any one of these?",
                    reply_markup=InlineKeyboardMarkup(btn))
